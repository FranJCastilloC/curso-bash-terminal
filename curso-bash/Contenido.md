...
```
drwxr-xr-x  4 francisco francisco 4096 abr 13 10:30 proyectos
...
```
-rwxr-xr-x  1  francisco  devs  4096  abr 13  script.sh
 │├─┤├─┤├─┤
 │ │   │  └── Otros (o)
 │ │   └───── Grupo (g)
 │ └───────── Dueño (u)
...
# ─── chown: cambiar dueño ───
sudo chown francisco archivo.txt
sudo chown francisco:devs archivo.txt    # Dueño Y grupo
sudo chown -R francisco:devs proyecto/   # Recursivo
